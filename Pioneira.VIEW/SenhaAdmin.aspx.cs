    ...
    public partial class SenhaAdmin : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string resp = ObjLogin.UdateSenhaAdmin(Session["UsuarioWS"].ToString(), Session["SenhaWS"].ToString(), Session["CodCliente"].ToString(), Session["Lojacliente"].ToString(), txt_senha_atual.Text, txt_senha_nova.Text);
